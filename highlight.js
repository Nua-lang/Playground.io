...
(function(n) {
    var b=[], o=Object.keys, h= {}
    , p= {}
    , t=/^(no-?highlight|plain|text)$/i, m=/\blang(?: uage)?-([\w-]+)\b/i, r=/((^(<[^>]+>|\t|)+|(?: \n)))/gm, a= {
        case_insensitive: "cI", lexemes: "l", contains: "c", keywords: "k", subLanguage: "sL", className: "cN", begin: "b", beginKeywords: "bK", end: "e", endsWithParent: "eW", illegal: "i", excludeBegin: "eB", excludeEnd: "eE", returnBegin: "rB", returnEnd: "rE", relevance: "r", variants: "v", IDENT_RE: "IR", UNDERSCORE_IDENT_RE: "UIR", NUMBER_RE: "NR", C_NUMBER_RE: "CNR", BINARY_NUMBER_RE: "BNR", RE_STARTERS_RE: "RSR", BACKSLASH_ESCAPE: "BE", APOS_STRING_MODE: "ASM", QUOTE_STRING_MODE: "QSM", PHRASAL_WORDS_MODE: "PWM", C_LINE_COMMENT_MODE: "CLCM", C_BLOCK_COMMENT_MODE: "CBCM", HASH_COMMENT_MODE: "HCM", NUMBER_MODE: "NM", C_NUMBER_MODE: "CNM", BINARY_NUMBER_MODE: "BNM", CSS_NUMBER_MODE: "CSSNM", REGEXP_MODE: "RM", TITLE_MODE: "TM", UNDERSCORE_TITLE_MODE: "UTM", COMMENT: "C", beginRe: "bR", endRe: "eR", illegalRe: "iR", lexemesRe: "lR", terminators: "t", terminator_end: "tE"
    }
    , N="</span>", v= {
    ...
    function _(e) {
        ...
        return function e(t, r) {
            for(var a=t.firstChild;
            a;
            a=a.nextSibling)3===a.nodeType?r+=a.nodeValue.length:1===a.nodeType&&(n.push( {
                event: "start", offset: r, node: a
            }
            ), r=e(a, r), f(a).match(/br|hr|img|input/)||n.push( {
                event: "stop", offset: r, node: a
            }
            ));
            return r
        }
    ...
    function k(e, t, c, r) {
        ...
        function l() {
            ...
            ():function() {
                var e, t, r, a, n, i, s;
                if(!b.k)return y(m);
                for(a="", t=0, b.lR.lastIndex=0, r=b.lR.exec(m);
                r;
                )a+=y(m.substring(t, r.index)), n=b, i=r, s=d.cI?i[0].toLowerCase(): i[0], (e=n.k.hasOwnProperty(s)&&n.k[s])?(f+=e[1], a+=o(e[0], y(r[0]))): a+=y(r[0]), t=b.lR.lastIndex, r=b.lR.exec(m);
                return a+y(m.substr(t))
            }
            (), m=""
        }
        function u(e) {
            p+=e.cN?o(e.cN, "", !0):"", b=Object.create(e, {
                parent: {
                    value: b
                }
            }
        ...
        function a(e, t) {
            ...
            var r=function(e, t) {
                var r, a, n;
                for(r=0, a=t.c.length;
                r<a;
                r++)if(w(t.c[r].bR, e))return t.c[r].endSameAsBegin&&(t.c[r].eR=(n=t.c[r].bR.exec(e)[0], new RegExp(n.replace(/[-\/\\^$*+?.()|[\] {}
                ]/g, "\\$&"), "m"))), t.c[r]
            }
            (t, b);
            ...
            if(i) {
                var s=b;
                for(s.skip?m+=t: (s.rE||s.eE||(m+=t), l(), s.eE&&(m=t));
                b.cN&&(p+=N), b.skip||b.sL||(f+=b.r), (b=b.parent)!==i.parent;
                );
        ...
        for(n=b;
        n!==d;
        n=n.parent)n.cN&&(p=o(n.cN, "", !0)+p);
        var m="", f=0;
        try {
            for(var s, g, _=0;
            b.t.lastIndex=_, s=b.t.exec(t);
            )g=a(t.substring(_, s.index), s[0]), _=s.index+g;
            for(a(t.substr(_)), n=b;
            n.parent;
            n=n.parent)n.cN&&(p+=N);
            return {
                r: f, value: p, language: e, top: b
            }
        }
        catch(e) {
    ...
    function s(e) {
        var t, r, a, n, i, s, c, o, l, u, d=function(e) {
            ...
            for(t=0, a=(i=i.split(/\s+/)).length;
            t<a;
            t++)if(g(n=i[t])||C(n))return n
        }
        (e);
        ...
        (r, _(n), i)), a.value=M(a.value), e.innerHTML=a.value, e.className=(s=e.className, c=d, o=a.language, l=c?p[c]:o, u=[s.trim()], s.match(/\bhljs\b/)||u.push("hljs"), -1===s.indexOf(l)&&u.push(l), u.join(" ").trim()), e.result= {
            language: a.language, re: a.r
        }
        , a.second_best&&(e.second_best= {
            language: a.second_best.language, re: a.second_best.r
        }
        ))
    }
    function c() {
    ...
    return n.highlight=k, n.highlightAuto=x, n.fixMarkup=M, n.highlightBlock=s, n.configure=function(e) {
        v=u(v, e)
    }
    ...
    , n.getLanguage=C, n.autoDetection=l, n.inherit=u, n.IR=n.IDENT_RE="[a-zA-Z]\\w*", n.UIR=n.UNDERSCORE_IDENT_RE="[a-zA-Z_]\\w*", n.NR=n.NUMBER_RE="\\b\\d+(\\.\\d+)?", n.CNR=n.C_NUMBER_RE="(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)", n.BNR=n.BINARY_NUMBER_RE="\\b(0b[01]+)", n.RSR=n.RE_STARTERS_RE="!|!=|!==|%|%=|&|&&|&=|\\*|\\*=|\\+|\\+=|,|-|-=|/=|/|:|;|<<|<<=|<=|<|===|==|=|>>>=|>>=|>=|>>>|>>|>|\\?|\\[|\\{|\\(|\\^|\\^=|\\||\\|=|\\|\\||~", n.BE=n.BACKSLASH_ESCAPE= {
        b: "\\\\[\\s\\S]", r: 0
    }
    ...
    return {
        ...
        , u, r, {
            bK:"class interface", e:/[ {
                ;
                =]/, i: /[^\s: , ]/, c: [e.TM, e.CLCM, e.CBCM]
            }
            , {
                bK:"namespace", e:/[ {
                    ;
                    =]/, i:/[^\s:]/, c:[e.inherit(e.TM, {
                        b: "[a-zA-Z](\\.?\\w)*"
                    }
                    ), e.CLCM, e.CBCM]
                }
                , {
                    cN:"meta", b:"^\\s*\\[", eB:!0, e:"\\]", eE:!0, c:[ {
                        cN: "meta-string", b: /"/,e:/"/
                    }
                    ]
                }
                ...
                , {
                    cN:"function", b:"("+d+"\\s+)+"+e.IR+"\\s*\\(", rB:!0, e:/\s*[ {
                        ;
                        =]/, eE:!0, k:t, c:[ {
            ...
            ;
            return {
                aliases: ["toml"], cI: !0, i: /\S/, c: [e.C(";", "$"), e.HCM, {
                    cN: "section", b: /^\s*\[+/, e: /\]+/
                }
                , {
                    ...
                    , {
                        ...
                        , {
                            ...
                            , {
                                cN:"function", b:"([À-ʸa-zA-Z_$][À-ʸa-zA-Z_$0-9]*(<[À-ʸa-zA-Z_$][À-ʸa-zA-Z_$0-9]*(\\s*,\\s*[À-ʸa-zA-Z_$][À-ʸa-zA-Z_$0-9]*)*>)?\\s+)+"+e.UIR+"\\s*\\(", rB:!0, e:/[ {
                                    ;
                                    =]/, eE:!0, k:t, c:[ {
                            ...
                            return {
                                aliases:["js", "jsx"], k:r, c:[ {
                                    cN: "meta", r: 10, b: /^\s*['"]use (strict|asm)['"]/},{cN:"meta",b:/^#!/,e:/$/},e.ASM,e.QSM,i,e.CLCM,e.CBCM,a,{b:/[{,]\s*/,r:0,c:[{b:t+"\\s*:",rB:!0,r:0,c:[{cN:"attr",b:t,r:0}]}]},{b:"("+e.RSR+"|\\b(case|return|throw)\\b)\\s*",k:"return throw case",c:[e.CLCM,e.CBCM,e.RM,{cN:"function",b:"(\\(.*?\\)|"+t+")\\s*=>",rB:!0,e:"\\s*=>",c:[{cN:"params",v:[{b:t},{b:/\(\s*\)/},{b:/\(/,e:/\)/,eB:!0,eE:!0,k:r,c:s}]}]},{b:/</,e:/(\/\w+|\w+\/)>/,sL:"xml",c:[{b:/<\w+\s*\/>/,skip:!0},{b:/<\w+/,e:/(\/\w+|\w+\/)>/,skip:!0,c:[{b:/<\w+\s*\/>/,skip:!0},"self"]}]}],r:0},{cN:"function",bK:"function",e:/\{/,eE:!0,c:[e.inherit(e.TM,{b:t}),{cN:"params",b:/\(/,e:/\)/,eB:!0,eE:!0,c:s}],i:/\[|%/},{b:/\$[(.]/},e.METHOD_GUARD,{cN:"class",bK:"class",e:/[{;=]/,eE:!0,i:/[:"\[\]]/, c:[ {
                                        bK: "extends"
                                    }
                                    , e.UTM]
                                }
                                , {
                                    bK:"constructor get set", e:/\ {
                                        /, eE: !0
                                    }
                                    ], i:/#(?!!)/
                                }
                                ...
                                , r= {
                                    cN: "string", b: /"/,e:/"/, c: [e.BE, t]
                                }
                                , a= {
                                    cN:"variable", b:/\$\([\w-]+\s/, e: /\)/, k: {
                                ...
                                , i= {
                                    cN: "section", b: /^[^\s]+: /, e: /$/, c: [t]
                                }
                                ;
                                return {
                                    aliases:["mk", "mak"], k:"define endef undefine ifdef ifndef ifeq ifneq else endif include -include sinclude override export unexport private vpath", l:/[\w-]+/, c:[e.HCM, t, r, a, n, {
                                        cN:"meta", b:/^\.PHONY:/, e:/$/, k: {
                                            "meta-keyword": ".PHONY"
                                        }
                                        , l:/[\.\w]+/
